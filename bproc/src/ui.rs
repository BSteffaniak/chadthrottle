...
impl AppState {
    pub fn new() -> Self {
        ...
        Self {
            ...
            status_message: String::from("bproc started. Press 'h' for help."),
            sort_frozen: false,
...
fn draw_header(f: &mut Frame, area: Rect) {
    let header = Paragraph::new("🔥 bproc v0.1.0 - Network Monitor & Throttler 🔥")
        .style(
            Style::default()
                .fg(Color::Cyan)
